 ...
 * determining 
 */
public class GameStateWithAdvancements {
	 ...
	 * Basic constructor.
	 */
	public GameStateWithAdvancements(Player p1, Player p2) {
		this(p1, p2, 8);
	}
	 ...
	 */
	public GameStateWithAdvancements(Player p1, Player p2, int boardSize) {
		if (boardSize >= 2) {
			...
			computeScores();
			this.gameOver = (!(hasLegalMoves(getPlayerByID(COUNTER_DARK)) || hasLegalMoves(getPlayerByID(COUNTER_LIGHT))));
		} else {
	 ...
	 * Cloning constructor.
	 */
	public GameStateWithAdvancements(GameStateWithAdvancements that) {
	...
	public int getEmptySpaces() {
		return (boardSize * boardSize) - getScoreOfID(COUNTER_DARK) - getScoreOfID(COUNTER_LIGHT);
	}
	 ...
	 */
	public GameStateWithAdvancements playMove(Player p, Point move) {
	 ...
	 */
	public GameStateWithAdvancements playMove(int id, Point move) {
		...
		GameStateWithAdvancements newState = new GameStateWithAdvancements(this);
	 ...
	 */
	public GameStateWithAdvancements rotate(int numRotates) {
		GameStateWithAdvancements newState = new GameStateWithAdvancements(this);
	 ...
	 */
	public boolean isEqual(GameStateWithAdvancements that) {
		boolean result = true;
	 ...
	 */
	public boolean isRotationOf(GameStateWithAdvancements that) {
		for (int rotation = 0; rotation < 4; ++rotation) {
			GameStateWithAdvancements thatRotated = that.rotate(rotation);
	 ...
	 */
	public boolean hasSameBoardAs(GameStateWithAdvancements that) {
